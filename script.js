const casas = [
  ...
  /*14*/ { background:"img/fundo/projeto-lean-nas-emergencias.png", tipo: "projeto"  },

  /*15*/ {background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto LEANS é focado exclusivamente na gestão financeira de hospitais?", resposta: false, explicacao: "O projeto abrange aspectos administrativos e assistenciais, não apenas financeiros.", tipo: "pergunta" },
  ...
  /*19*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto ATS Educação capacita gestores apenas para gestão financeira?", resposta: false, explicacao: "O projeto aborda avaliação de tecnologias em saúde e não se limita à gestão financeira.", tipo: "pergunta" },
  ...
  /*23*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Preceptoria Médica forma apenas profissionais de enfermagem?", resposta: false, explicacao: "O projeto é voltado à formação de novos médicos.", tipo: "pergunta" },
  ...
  /*19*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Saúde em nossas Mãos trata de agricultura familiar?", resposta: false, explicacao: "O projeto foca na segurança e qualidade no atendimento hospitalar.", tipo: "pergunta" },
  ...
  /*22*/ { background:"img/fundo/projeto-preceptoria-mfc.png", titulo: "", conteudo: "", video: "/img/videoteste.mp4",  tipo: "projeto"  },

  /*25*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto MFC bla bla bla?", resposta: false, explicacao: "O projeto é voltado à formação de novos médicos.", tipo: "pergunta" },

  
  /*22*/ { background:"img/fundo/projeto-preceptoria-multiprofissional.png", titulo: "", conteudo: "", video: "/img/videoteste.mp4",  tipo: "projeto" },

  /*27*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Preceptoria Multiprofissional envolve apenas médicos?", resposta: false, explicacao: "O projeto promove a formação em equipes multiprofissionais.", tipo: "pergunta" },

  /*28*/ {background:"img/fundo/projeto-saude-indigena.png",  tipo: "projeto"  },
  ...
  /*29*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Saúde Indígena busca integrar as tradições indígenas ao atendimento em saúde?", resposta: true, explicacao: "O projeto promove ações específicas para populações indígenas, respeitando suas tradições.", tipo: "pergunta" },


  /*30*/ {background:"img/fundo/projeto-artemis.png", titulo: "", conteudo: "", video:"https://www.youtube.com/watch?v=X2WEOnF5mao",  tipo: "projeto"  },

  /*31*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "Diretrizes bla bla bla?", resposta: false, explicacao: "O estudo é direcionado para doenças crônicas, não agudas.", tipo: "pergunta" },
  ...
  /*33*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O Estudo CuidAR é voltado para doenças respiratórias agudas?", resposta: false, explicacao: "O estudo é direcionado para doenças crônicas, não agudas.", tipo: "pergunta" },

  /*34*/ {background:"img/fundo/projeto-estudo-cuidar.png", titulo: "", conteudo: "",  tipo: "projeto"  },

  /*31*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Artemis está relacionado à transformação digital na saúde?", resposta: true, explicacao: "O projeto Artemis promove transformação digital na saúde.", tipo: "pergunta" },
  ...
  /*19*/ {background:"img/fundo/projeto-estudo-prisma.png", titulo: "", conteudo: "",  tipo: "projeto"  },

  /*31*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "Estudo HTLV (PRISMA) alerar pergunta?", resposta: true, explicacao: "O projeto Artemis promove transformação digital na saúde.", tipo: "pergunta" },

  /*19*/{background:"img/fundo/projeto-estudo-otimo.png", titulo: "", conteudo: "", video: "/img/videoteste.mp4",  tipo: "projeto"  },

  /*31*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "Estudo otimo alerar pergunta?", resposta: true, explicacao: "O projeto Artemis promove transformação digital na saúde.", tipo: "pergunta" },
  ...
  /*39*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Onco-Genomas Brasil analisa tratamentos personalizados para câncer?", resposta: true, explicacao: "O projeto estuda o perfil genético de cânceres no Brasil.", tipo: "pergunta" },
  ...
  /*40*/ {background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto Pós-Covid Brasil estuda apenas os impactos físicos da Covid-19?", resposta: false, explicacao: "O estudo avalia os impactos físicos, mentais e sociais.", tipo: "pergunta" },
  
  /*20*/ { background:"img/fundo/projeto-pos-covid.png", titulo: "", conteudo: "",  video: "/img/videoteste.mp4",  tipo: "projeto" },



  /*41*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O projeto RHP aborda padrões de cuidado em redes hospitalares?", resposta: true, explicacao: "O projeto estuda redes hospitalares e padrões de cuidado.", tipo: "pergunta" },

  /*22*/ {  background:"img/fundo/projeto-rhp.png", titulo: "", conteudo: "",  tipo: "projeto"  },
  ...
  /*47*/ { background:"img/fundo/ta-certo-isso.png", pergunta: "O Projeto TNK alterar pergunta?", resposta: false, explicacao: "O projeto foca na reabilitação de pacientes em ventilação mecânica prolongada.", tipo: "pergunta" },
